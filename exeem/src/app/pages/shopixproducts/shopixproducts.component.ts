...
@Component({
  selector: 'app-shopixproducts',
  templateUrl: './shopixproducts.component.html',
  styleUrls: ['./shopixproducts.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class ShopixproductsComponent implements OnInit {
